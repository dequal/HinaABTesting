 ...
 *
 */
typedef NS_ENUM(NSInteger, HNABFetchResultResponseStatus) {
    /// 拉取试验成功
    HNABFetchResultResponseStatusSuccess,
    /// 拉取试验失败
    HNABFetchResultResponseStatusFailed
};
...
/// 网络回调完整数据结构
@interface HNABFetchResultResponse : NSObject<NSCoding>

/// 获取试验状态
@property (nonatomic, assign) HNABFetchResultResponseStatus status;
